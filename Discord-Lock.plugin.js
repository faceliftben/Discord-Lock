 ...
 * @name Discord-Lock
 * @author Facelift/Ben
 * @authorLink https://github.com/faceliftben
 * @invite HkW396rDj6
 * @version 1.0.0
 * @description Mache dein Discord Sicherer..
 */
...
module.exports = (() => {
    const config = {
        "info": {
            ...
            "authors": [
                {
                    "name": "Facelift/Ben",
                    "discord_id": '640256514267021314',
                    "github_username": 'faceliftben'
                }
            ],
            "version": "1.0.0",
            "description": "Mache dein Discord Sicherer."
        ...
        "changelog": [
            {
                ...
                "title": "Danke",
                "items": [
                    "Danke das du mein Discod-Lock Plugin nutzt",
                ]
            },
    ...
    return !global.ZeresPluginLibrary ? class {
        ...
        load() {
            BdApi.showConfirmationModal("Bibliothek fehlt", `Das Bibliotheks-Plugin, das für benötigt wird ${config.info.name} fehlt. Bitte klicken Sie auf Jetzt herunterladen, um es zu installieren.`, {
        ...
        const plugin = (Plugin, Api) => {
            ...
            class PasscodeLocker extends React.Component {
                ...
                componentDidMount() {
                    ...
                    if (this.props.type === PasscodeLocker.Types.DEFAULT) this.enableNotifications = this.props.plugin.settings.hideNotifications
                        ...
                        : Patcher.before(DiscordModules.NotificationModule, 'showNotification', (self, params) => {
                            ...
                            params[1] = 'Neue Benachrichtigung';
                            params[2] = 'Du hast 1 neue Benachrichtigung!';
                ...
                render() {
                    ...
                    const titleText = () => {
                        if (this.props.type === PasscodeLocker.Types.EDITOR) return !this.state.confirm ? 'Gib bitte dein Wunsch-Passwort ein :)' : 'Gib bitte das erneut Discord-Passwort ein';
                        return 'Gib bitte das Discord-Passwort ein';
                    };
            ...
            return class PasscodeLock extends Plugin {
                ...
                async lock({ button, type, onSuccess } = {}) {
                    ...
                    if (this.settings.hash === -1 && type !== PasscodeLocker.Types.EDITOR) return Toasts.error('Bitte richte zuerst den Passcode in den Plugin-Einstellungen ein.');
...
`);
                ...
                updateCode(code) {
                    ...
                    Toasts.success('Passwort erfolgreich geändert :)');
                }
                ...
                getSettingsPanel() {
                    ...
                    const settingsNode = Settings.SettingPanel.build(
                        ...
                        new Settings.SettingField(null, null, () => {}, Buttons(
                            {
                                children: ButtonIcon('edit', 'Pass-Code ändern'),
                                icon: true,
                            ...
                            {
                                children: ButtonIcon('lock', 'Discord Sperren'),
                                icon: true,
                        ...
                        new Settings.RadioGroup('Code type', null, this.settings.codeType, [
                            {
                                name: '4-stelliger numerischer Code',
                                value: PasscodeLock.Types.FOUR_DIGIT
                            },
                            {
                                name: '6-stelliger numerischer Code',
                                value: PasscodeLock.Types.SIX_DIGIT
                            },
                            {
                                name: 'Benutzerdefinierter numerischer Code',
                            ...
                            Toasts.warning('Dein Passwort wurde zurückgestzt. Du musst es erneut einrichten :)');
                        ...
                        new Settings.RadioGroup('Auto-lock', 'Passcode bei längerer Abwesenheit erforderlich.', this.settings.autolock, [
                            {
                                name: 'Deaktiviert',
                                value: false
                            },
                        ...
                        new Settings.SettingField('Tastenbelegung sperren', null, () => {}, props => {
                        ...
                        new Settings.Switch('Beim Start immer sperren', 'Sperrt Discord beim Start, auch wenn es vor dem Herunterfahren von Discord nicht gesperrt war', this.settings.lockOnStartup, e => {
                            this.settings.lockOnStartup = e;
                            this.saveSettings();
                        }),

                        new Settings.Switch('Tastatureingabe hervorheben', 'Hebt Schaltflächen auf dem Bildschirm hervor, wenn der Passcode über die Tastatur eingegeben wird', this.settings.highlightButtons, e => {
                            this.settings.highlightButtons = e;
                            this.saveSettings();
                        }),

                        new Settings.RadioGroup('Benachrichtigungen bei Sperrung', null, this.settings.hideNotifications, [
                            {
                                name: 'Benachrichtigungen deaktivieren',
                                value: true
                            },
                            {
                                name: 'Benachrichtigungen zensieren',
                                value: false
                            },
                        ], e => {
                ...
                constructor() {
                    ...
                    if (this.settings.code) {
                        ...
                        Toasts.warning('Dein Passcode wurde aufgrund eines Sicherheitsupdates zurückgesetzt. Richte es in den Einstellungen erneut ein.');
                    }
...
Dieses Plugin **TUT** verhindert, dass Leute beiläufig schnüffeln, **ABER** wenn jemand Zugriff auf den Computer hat, während Discord angemeldet ist und tatsächlich entschlossen ist, darauf zuzugreifen, **da gibt es nichts, was PasscodeLock tun kann** den Umfang eines BD-Plugins, um sie zu verhindern.
\nDie wirkliche Lösung aus Sicherheitssicht ist einfach... Ihren Computer zu sperren oder sich abzumelden, wenn Sie nicht gerade dabei sind. *(c) Qwerasd*`
                                        )
                                    )
                                ]
                            );
